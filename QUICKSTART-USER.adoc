...
// Replace ponyiser, Ponyiser — See README.adoc for details., just run, Ponyiser started successfully. with actuals
= ponyiser — Quick Start for Users
:toc:
:toclevels: 2

== What is ponyiser?

Ponyiser — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./ponyiser-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/ponyiser/wiki
