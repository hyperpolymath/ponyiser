...
Replace all {{PLACEHOLDER}} values with your information:
  Ponyiser     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  ponyiser             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/ponyiser/security/advisories/new)
...
- This repository (`hyperpolymath/ponyiser`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/ponyiser/security/advisories)
...
When using Ponyiser, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/ponyiser/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/ponyiser/security/advisories/new) or {{SECURITY_EMAIL}} |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/ponyiser/discussions) |
...
*Thank you for helping keep Ponyiser and its users safe.* 🛡️
